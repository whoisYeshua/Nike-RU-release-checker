    ...
    getProductId()
        ...
        .catch(e => {
            ...
            if (e.message === 'Failed to fetch') {
                const span = `<span>Due to new Nike CORS policy this method doesn\`t work. Check new solution at link below</span>`
                ...
                document.querySelector('main.modal__content').insertAdjacentHTML('afterbegin', span)
                document.querySelector('main.modal__content').insertAdjacentHTML('beforeend', modalBtn)
                MicroModal.show('modal-1', {
                    onClose: () => (document.querySelector('main.modal__content').innerHTML = ''),
                })
            }
        })
}
            ...
            if (product.slug === productSlug) {
                ...
                if (product.models.length > 1) {
                    product.models.forEach(model => {
                        ...
                        document.querySelector('main.modal__content').insertAdjacentHTML('afterbegin', modalBtn)
                    })
